...
//	public static String privateKey ="cert\\testSpay.key.p8";	//商户私钥
	...
	public static String privateKey =ConfigUtil.getConfig("certpath")+"testSpay.key.p8";	//商户私钥

	public static String certFilePath = ConfigUtil.getConfig("certpath");	//联动证书
	public static String serverCertFileName = "testUmpay.cert.crt";
	
    public static void main( String[] args ) 
    {
//        LogUtil.info(addSign());
//        LogUtil.info(doCheckSign(addSign()));
